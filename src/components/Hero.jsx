...
export default function Hero({ onFindEscapeClick }) {
  return (
    <section className="relative min-h-[94vh] lg:min-h-screen w-full flex flex-col justify-between -mt-20 pt-24 pb-12 lg:pb-16 px-gutter-mobile lg:px-gutter-desktop overflow-hidden">
      <motion.div
      ...
      />
      <div className="absolute inset-0 bg-gradient-to-b from-surface-container-lowest/90 via-surface-dim/55 to-surface z-10 pointer-events-none"></div>
      <div className="absolute inset-0 bg-[radial-gradient(ellipse_at_center,_transparent_20%,_#0a1422_95%)] z-10 pointer-events-none"></div>
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-primary-container/15 rounded-full blur-[140px] pointer-events-none z-10"></div>
      <div className="absolute bottom-1/4 right-1/4 w-80 h-80 bg-secondary/15 rounded-full blur-[120px] pointer-events-none z-10"></div>

      <div className="relative z-20 pt-8 flex items-center justify-between">
        <div className="inline-flex items-center gap-space-xs px-space-md py-space-2xs rounded-full bg-surface-container-high/70 backdrop-blur-xl shadow-lg">
        ...
        <div className="hidden md:flex items-center gap-space-sm px-space-md py-space-2xs rounded-full bg-surface-container-lowest/60 backdrop-blur-md">
      ...
      <div className="relative z-20 my-auto py-12 max-w-7xl mx-auto w-full grid grid-cols-1 lg:grid-cols-12 gap-space-xl items-end">
        <div className="lg:col-span-8 flex flex-col gap-space-md">
          <div className="flex items-center gap-space-xs font-label-caps text-label-caps uppercase tracking-[0.25em] text-secondary">
          ...
          >
            <a 
              className="group relative inline-flex items-center justify-center gap-space-xs px-space-xl py-space-md rounded-full bg-primary-container text-on-primary-container font-label-caps text-label-caps uppercase tracking-widest shadow-[0_0_32px_rgba(255,107,74,0.45)] hover:bg-primary transition-all duration-300 active:scale-95 overflow-hidden" 
              href="#mood-section"
              onClick={onFindEscapeClick}
            >
              <span className="relative z-10 flex items-center gap-space-xs font-bold">FIND MY ESCAPE <span className="material-symbols-outlined text-[18px] group-hover:translate-x-1 transition-transform">arrow_forward</span></span>
              <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-700 bg-gradient-to-r from-transparent via-white/30 to-transparent"></div>
            </a>
            <a className="inline-flex items-center gap-space-xs px-space-lg py-space-md rounded-full bg-surface-container/60 hover:bg-surface-container-high/80 backdrop-blur-xl text-on-surface font-label-caps text-label-caps uppercase tracking-wider transition-all duration-300" href="#destinations">
              <span className="material-symbols-outlined text-[16px] text-secondary">explore</span> Explore Coordinates
            </a>
          </motion.div>
        </div>
        ...
        <div className="lg:col-span-4 flex justify-start lg:justify-end">
          ...
          >
            ...
            <div className="flex items-center gap-space-md py-space-xs">
              <div className="relative w-16 h-16 rounded-full bg-surface-container-lowest/80 flex items-center justify-center shadow-inner">
                <motion.svg 
      ...
      <div className="relative z-20 flex justify-between items-center text-on-surface-variant pt-4">
        <span className="font-label-numeric text-label-numeric text-outline hidden sm:inline">01 // THE EXPEDITION PORTAL</span>
        <a className="flex items-center gap-space-xs font-label-caps text-label-caps uppercase hover:text-secondary transition-colors mx-auto lg:mx-0" href="#mood-section">
          <span>Scroll to calibrate mood</span>
          <span className="material-symbols-outlined text-[16px] animate-bounce">south</span>
        </a>
        <span className="font-label-numeric text-label-numeric text-outline hidden sm:inline">RADIUS: ≤ 240 KM</span>
      </div>
    </section>
  );
}